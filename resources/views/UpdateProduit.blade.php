...
<body>
    ...
    <form method="post" action="/UpdateProduit/{{$prd->id}}" enctype="multipart/form-data">
        <div>
            ...
            <select value="{{$prd->category_id}}" id="category_id" name="category_id" style="width: 50vw;" class="my-3 mx-4 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @foreach($cat as $c)
